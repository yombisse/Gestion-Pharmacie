                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="sexe" class="form-control @error('sexe') is-invalid @enderror">
                                        ...
                                        <option value="personnalisee" {{ old('sexe', $personnel->sexe) == 'personnalisee' ? 'selected' : '' }}>Personnalisé</option>
                                    </select>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($personnel->photo)
                                <div class="mt-2">
                                    <img src="{{ asset($personnel->photo) }}" alt="Photo actuelle" class="img-thumbnail" style="width: 100px;">
