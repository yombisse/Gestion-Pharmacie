...
@section('content')
    ...
    <div class="wrapper d-flex">
        ...
        <div class="sidebar d-flex flex-column p-3 bg-primary" style="min-width: 250px;margin: left 0;">
            <h5 class="text-center mb-4"><i class="bi bi-person-circle me-2"></i> {{ Auth::user()->firstname }} {{ Auth::user()->name }} </h5>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <img src="{{ Auth::user()->avatar }}" class="rounded-circle" width="60" height="60" alt="Avatar">
                    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item"><i class="bi bi-person-fill me-2"></i>Nom :{{ Auth::user()->name }} </li>
                        <li class="list-group-item"><i class="bi bi-person-fill me-2"></i>Prenom:{{ Auth::user()->firstname }} </li>
                        <li class="list-group-item"><i class="bi bi-envelope-fill me-2"></i>Email :{{ Auth::user()->email }} </li>
                    </ul>
